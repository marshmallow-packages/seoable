        ...
        <template #value class="seo-meta-detail">
            ...
            >
                <div class="seo-meta-detail__wrapper">
                    ...
                    >
                        <div class="seo-meta-detail__google__title">
                            {{ seoTitle }}
                        </div>
                        <div class="seo-meta-detail__google__url">
                            {{
                        ...
                        <div class="seo-meta-detail__google__description">
                ...
                <div class="seo-meta-detail__wrapper">
                    ...
                    >
                        ...
                        <div class="seo-meta-detail__facebook__info">
                            <div class="seo-meta-detail__facebook__domain">
                                {{
                                    field.hostname.replace(/^https?:\/\//g, "")
                                }}
                            </div>
                            <div class="seo-meta-detail__facebook__title">
                                {{ seoTitle }}
                            </div>
                        </div>
                    </div>
